    ...
    <>
      ...
      <header className="topbar">
        <div className="topbar-left">
          <a href="/" className="brand" aria-label="xRO">
            {/* Sigil mark — el X rotado del launcher */}
            <svg width="22" height="22" viewBox="0 0 600 600" fill="none" aria-hidden style={{ marginRight: 8, flexShrink: 0 }}>
          ...
          <span className="mono-sub">Renewal · Mid Rate x10</span>
          <span className="status-pill">
            <span className="dot" />
            <span className="strong">Online</span>
            <span className="sep">·</span>
            <span>1,284 jugadores</span>
            <span className="sep">·</span>
            <span>Ping 38ms</span>
          </span>
        </div>
      ...
      <main className={styles.shell}>
        ...
        <section className={styles.indexRow} id="features">
          ...
          <div className={styles.indexList}>
            {[
              ...
              { n: "/ 02", title: <>Economía <em>honesta</em>, sin tienda P2W.</>, desc: "Solo cosméticos. Auctioneer global. Vending semi-persistente." },
              { n: "/ 03", title: <>WoE TE <em>sábados</em> · BG diario.</>, desc: "21:00 GMT-3. Battlegrounds 5v5 19–24h." },
              { n: "/ 04", title: <>Instancias <em>matched</em>, no solo guild.</>, desc: "Matchmaking de party para old & memorial dungeons." },
              { n: "/ 05", title: <>Soporte <em>humano</em>, GMs activos.</>, desc: "Tickets 24h. Discord con devs en directo." },
            ].map((item) => (
              <div className={styles.indexItem} key={item.n}>
                <span className={styles.indexNum}>{item.n}</span>
        ...
        <section className={styles.showcase}>
          <div className={styles.showcaseTile}>
            ...
            <img src="/art/city-prontera.jpg" alt="Ciudad de Prontera" />
            <div className={styles.showcaseBody}>
              <div className="eyebrow-line">Capital</div>
              <h4 className={styles.showcaseH4}>Prontera, <em>como debe ser</em>.</h4>
            </div>
          </div>
          <div className={styles.showcaseTile}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/art/city-geffen.jpg" alt="Ciudad de Geffen" />
            <div className={styles.showcaseBody}>
              <div className="eyebrow-line">Torre del mago</div>
              <h4 className={styles.showcaseH4}>Geffen, <em>intacta</em>.</h4>
            </div>
          </div>
        </section>

        {/* ── DISCORD ── */}
        <section className={styles.discordRow} id="discord">
          <div className={styles.discordCard}>
            ...
            <div className={styles.discordActions}>
              ...
              <span className={styles.discordPresence}>
                <span className={styles.discordDot} />1,284 online · 8,720 miembros
              </span>
            </div>
          </div>
        </section>
        ...
        <section className={styles.bottomCta} id="descargar">
          ...
          <div className={styles.bottomCtaRight}>
            <p className={styles.bottomCtaP}>
              ...
              antes de cada inicio. Cero configuración manual, cero DLLs sueltas.
            </p>
            <div className={styles.downloadBlock}>
              <a href="https://cdn.xro-server.es/launcher/xRO-Launcher-Setup.exe" className={styles.downloadMain}>
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden>
            ...
            <span className="mono-sub" style={{ fontSize: "10px" }}>
              Windows 10 / 11 · 1.4 GB · v7.14 · SHA256 verificado
            </span>
          </div>
        </section>
      ...
      <footer className="footer">
        ...
        <div className="footer-bottom">
          ...
          <span className="mono-sub">Servidor v7.14 · Cliente 2025-07-16</span>
        </div>
      </footer>
    </>
  );
